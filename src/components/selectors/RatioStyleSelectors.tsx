      ...
      {isOpen && typeof document !== 'undefined' && createPortal(
        ...
        >
          ...
          {customOptions && customOptions.length > 0 && (
            <div className="mt-2 border-t border-[var(--glass-stroke-soft)] pt-2">
              <div className="mb-1 text-xs text-[var(--glass-text-tertiary)]">自定义风格</div>
              <div className="grid grid-cols-2 gap-2">
                    ...
                    <div key={option.value} className="group relative">
                      ...
                      <div className="absolute -top-1 -right-1 hidden gap-0.5 group-hover:flex">
                        {onEditCustom && (
                          <button
                            type="button"
                            onClick={(e) => { e.stopPropagation(); onEditCustom(option.value) }}
                            className="flex h-5 w-5 items-center justify-center rounded-full bg-[var(--glass-surface-modal)] text-[var(--glass-text-secondary)] shadow hover:text-[var(--glass-tone-info-fg)]"
                            title="编辑"
                          >
                        ...
                        {onDeleteCustom && (
                          <button
                            type="button"
                            onClick={(e) => { e.stopPropagation(); onDeleteCustom(option.value) }}
                            className="flex h-5 w-5 items-center justify-center rounded-full bg-[var(--glass-surface-modal)] text-[var(--glass-text-secondary)] shadow hover:text-[var(--glass-tone-danger-fg)]"
                            title="删除"
                          >
