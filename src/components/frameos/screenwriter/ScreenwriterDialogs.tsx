...
export function VideoToTextDialog({ mode, onClose }: { mode: 'script' | 'board'; onClose: () => void }) {
...
export function RepaintDialog({ mode, onClose }: { mode: 'script' | 'board'; onClose: () => void }) {
