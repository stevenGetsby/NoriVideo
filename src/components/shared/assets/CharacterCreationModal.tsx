      ...
      <div className="glass-surface-modal max-w-lg w-full max-h-[85vh] flex flex-col">
        <div className="p-6 overflow-y-auto flex-1">
          ...
          <CharacterCreationForm
            ...
            onAddCustomStyle={openAddCustomStyle}
            onEditCustomStyle={openEditCustomStyle}
            onDeleteCustomStyle={(value) => { void removeCustomStyle(value) }}
        ...
        <div className="flex items-center justify-end gap-2 p-4 border-t border-[var(--glass-stroke-base)] bg-[var(--glass-bg-surface-strong)] rounded-b-xl flex-shrink-0">
          ...
          {createMode === 'upload' ? (
            ...
            >
              {isSubmitting ? t('common.adding') : t('character.uploadAndCreate')}
            </button>
        ...
        <CustomArtStyleModal
          ...
          onSave={(data) => { void saveCustomStyle(data) }}
