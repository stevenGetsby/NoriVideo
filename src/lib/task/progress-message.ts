...
const STAGE_LABELS: Record<string, string> = {
  ...
  export_collecting: 'progress.stage.exportCollecting',
  export_manifest_ready: 'progress.stage.exportManifestReady',
  export_recorded: 'progress.stage.exportRecorded',
}
