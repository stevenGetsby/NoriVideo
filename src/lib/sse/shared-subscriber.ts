...
type GlobalSharedSubscriber = typeof globalThis & {
  __noriSharedSubscriber?: SharedSubscriber
}

const globalForSharedSubscriber = globalThis as GlobalSharedSubscriber

export function getSharedSubscriber() {
  if (!globalForSharedSubscriber.__noriSharedSubscriber) {
    globalForSharedSubscriber.__noriSharedSubscriber = new SharedSubscriber()
  }
  return globalForSharedSubscriber.__noriSharedSubscriber
}
