...
export function ProviderAdvancedFields({
  ...
  if (providerKey === 'mediakit') {
    return (
      <div className="p-3">
        <div className="rounded-xl border border-[var(--glass-stroke-soft)] bg-[var(--glass-bg-surface)] px-3 py-3 text-[12px] leading-relaxed text-[var(--glass-text-secondary)]">
          {t('apiKeyOnlyProviderHint')}
        </div>
      </div>
    )
  }
