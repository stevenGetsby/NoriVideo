                      ...
                      <div className="space-y-3">
                        <div>
                          ...
                          <textarea
                            ...
                            className="w-full px-3 py-2 border border-[var(--glass-stroke-strong)] rounded-lg focus:ring-2 focus:ring-[var(--glass-tone-info-fg)] focus:border-[var(--glass-stroke-focus)] text-sm resize"
                            rows={4}
                            autoFocus
                          />
                        </div>
